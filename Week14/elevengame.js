...
function setup()
{
    ...
    for (i = 0; i < 5; i++) {
        arrayshapes[i] = new shape(Math.floor(Math.random() * (Math.floor(Math.random() * 200))), Math.floor(Math.random() * (Math.floor(Math.random() * 200))), Math.floor(Math.random() * (Math.floor(Math.random() * 200))), (Math.floor(Math.random() * 255)), Math.floor(Math.random() * 255), Math.floor(Math.random() * 255));
    }
}
var yaayyyyy = 0;
